...
import {api} from 'lwc'
import {ingredientsFormat} from '../../utils/utils'

export default class DetailRecipe extends LightningElementWithBootstrap {
   ...
   @api recipe = {
    ...
    get ingredients() {
        return ingredientsFormat(this.recipe)
        //return ingredientsFormat(3)
    }
    ...
    handleBackButton(e) {
        ...
        const navigateEvent = new CustomEvent('navigatehome')
